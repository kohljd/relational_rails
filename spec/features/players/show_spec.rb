...
RSpec.describe "Players Show Page", type: :feature do
  ...
  let!(:player2) {campaign2.players.create!(name: "Amy", game_master: false, character_name: "Francis", sessions_missed: 5, active_player: false)}
  ...
  describe "when user visits" do
    ...
    describe "displays player's attributes" do
      ...
      it "active player" do
        ...
        expect(page).to_not have_content(player2.active_player)
      end
    end
